      ...
      <div className="bg-[var(--color-card)] border border-[var(--color-border)] rounded-xl w-full max-w-lg shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input name="amount" required type="number" step="1" min="0" className="w-full bg-[var(--color-input)] border border-[var(--color-border)] rounded py-2 px-3 text-white font-mono focus:outline-none focus:border-[var(--color-primary)] text-sm" placeholder="1000000" />
          </div>
          <div>
