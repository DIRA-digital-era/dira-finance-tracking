...
export default function AddUserForm({ currentRole, jobTitles }: { currentRole: string, jobTitles: any[] }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
       <div className="bg-[var(--color-card)] border border-[var(--color-border)] rounded-xl w-full max-w-lg overflow-hidden relative shadow-[0_0_50px_rgba(0,0,0,0.8)]">
           ...
           <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
              ...
              <div>
                 ...
                 <div className="relative">
                    ...
                    <input name="email" required type="email" className="w-full bg-[var(--color-input)] border border-[var(--color-border)] rounded py-3 pl-10 pr-3 text-white focus:outline-none focus:border-[var(--color-primary)]" placeholder="employee@dira.inc" />
                 </div>
              </div>
              <div>
                 ...
                 <div className="relative">
                    ...
                    <input name="password" required type={showPass ? 'text' : 'password'} className="w-full bg-[var(--color-input)] border border-[var(--color-border)] rounded py-3 pl-10 pr-10 text-white focus:outline-none focus:border-[var(--color-primary)]" placeholder="Temporary Secret Key" />
              ...
              <div>
                 <label className="block text-xs font-bold text-gray-400 mb-2 tracking-wider uppercase">Professional Titles (Optional)</label>
