...
export function AddJobTitleForm() {
    ...
    return (
        <form onSubmit={handleAdd} className="flex gap-2 mt-4">
            <input type="text" name="title" required placeholder="e.g. Frontend Engineer" className="flex-1 bg-[var(--color-input)] border border-[var(--color-border)] rounded py-2 px-3 text-sm text-white focus:outline-none focus:border-[var(--color-primary)]" />
